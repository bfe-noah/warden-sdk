...
the loader usually patches this); the CPU clock mux in clk-rv1106 (section M1 item 4); the
...
## M4/M5/M6: NEXT
- **M4 display**: VOP2 + the RGB666 720x720 panel + GT911 touch + PWM backlight ->
