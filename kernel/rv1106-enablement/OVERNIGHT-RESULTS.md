...
Goal (Noah): port/enable **every** remaining RV1106 hardware capability on the
...
| Driver | Evidence |
|---|---|
| **AIC8800 wifi** (M5) | wlan0 up (b4:04:29:22:34:92), `iw scan` found SSID "BlueFlare" −43 dBm + others. Modules (built-in deadlocks the two-stage SDIO bring-up). |
...
## Morning (needs Noah at the bench)
