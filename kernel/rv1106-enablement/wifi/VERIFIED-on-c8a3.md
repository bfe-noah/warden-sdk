...
- `insmod aic8800_fdrv.ko` → `ieee80211 phy0: HT supp 1, VHT supp 1, HE supp 1`,
  FDRV_RC=0.
- `wlan0: <BROADCAST,MULTICAST,UP,LOWER_UP> ... link/ether b4:04:29:22:34:92`
- `iw dev wlan0 scan` found real APs:
  - **SSID "BlueFlare"  d0:ea:11:3b:18:ce  2412 MHz  −43 dBm**
  - "Explore Guest"  02:ec:da:a1:64:4a  2412 MHz  −73 dBm
